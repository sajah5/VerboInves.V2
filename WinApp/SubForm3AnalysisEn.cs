...
namespace WinApp
{
    public partial class SubForm3AnalysisEn : Form
    {
        ...
        {
            isForm5Open = true;
            PasswordSubForm4En subform4 = new PasswordSubForm4En();
        ...
        private void DisplayResultsInReport(List<string> results, bool displayMetadata, bool displayHashValue, bool displayVBA, bool displayKeywordSearch, bool displayArtifact, bool displayMalware)
        {
            ...
            ReportEn resultsForm = new ReportEn();
        ...
        private void checkBoxKeyword_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                DialogResult result = MessageBox.Show("Do you want to Upload a Word List?", "Word List Creation", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (result == DialogResult.Yes)
                {
                    // عرض نموذج إنشاء قائمة الكلمات
                    SubForm5ListSplashEn wordListForm = new SubForm5ListSplashEn();
                ...
                else
                {
                    ...
                    wordListFilePath = @"C:\Users\saja\Desktop\project\Project\Project codes\Python Codes\Word_List\wordlist.txt"; // استخدام مسار ملف القائمة الأصلي
                }
            }
            else
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SubForm2AcquisitionEn subForm2 = new SubForm2AcquisitionEn();
