...
namespace WinApp
{
    public partial class SubForm2AcquisitionEn : Form
    {
        private Loading loadingForm;
        private List<string> allFiles; // قائمة لجميع ملفات الوورد
        private SubForm3AnalysisEn subForm3; // متغير عضو لتخزين مثيل SubForm3

        public SubForm2AcquisitionEn()
        {
            InitializeComponent();
        ...
        private void OpenFileInSubForm3(string filePath)
        {
            if (subForm3 == null)
            {
                subForm3 = new SubForm3AnalysisEn();
            }
